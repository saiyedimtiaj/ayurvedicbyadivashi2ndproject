...
const products = [
  {
    id: 4,
    name: "200ml ইন্ডিয়ান আদিবাসী হেয়ার অয়েল + 100gm আদিবাসী হেয়ার স্পা প্যাক-(একদম ফ্রি)।",
    price: 1650,
    image: prod3,
  ...
  {
    id: 3,
    name: "400ml ইন্ডিয়ান আদিবাসী হেয়ার অয়েল + 200gm আদিবাসী হেয়ার স্পা প্যাক-(একদম ফ্রি)।",
    price: 3260,
    image: prod4,
    isFreeDelibery: true,
